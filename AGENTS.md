...
`DESIGN.md` and `PLAN.md` are the guiding documents for Glyph.

- Read `DESIGN.md` before making architecture, data model, UI, or AI integration changes.
- Read `PLAN.md` before starting implementation work.
- Update `PLAN.md` when tasks are completed, added, removed, or materially re-scoped.
